...
function Weather() {
  ...
  return (
    <div className="bg-gradient-to-r from-green-400 to-blue-500 min-h-screen flex flex-col items-center justify-center p-4">
      <h1 className="font-bold text-5xl p-5 m-10">Abi Weather App</h1>
      <div className="bg-white p-8 rounded-xl w-full max-w-md shadow-lg">
        <h1 className="font-bold text-4xl mb-4 text-center text-gray-800">
          🌤️ Weather Report
        </h1>
        ...
        <input
          ...
          className="mt-2 border border-gray-300 rounded-md p-3 w-full focus:outline-none focus:ring-2 focus:ring-blue-400"
        />

        <button
          onClick={getWeather}
          className="mt-4 bg-blue-600 text-white p-3 rounded-md w-full hover:bg-blue-700 transition duration-300 cursor-pointer"
        >
          Get Weather
        </button>
      ...
      {/* Social Media Icons */}
      <div className="mt-8 flex gap-8 text-white text-3xl">
        <a
      ...
      <p className="mt-4 text-white text-sm">© 2025 Abishek S</p>
    </div>
  );
}
